    ...
    <DashboardLayout>
      ...
      <Tabs defaultValue="branding" className="space-y-6">
        <TabsList className="bg-muted/50 p-1">
          <TabsTrigger value="branding" className="data-[state=active]:bg-card data-[state=active]:shadow-sm">
            <Palette className="w-4 h-4 mr-2" />
            Branding
          </TabsTrigger>
          <TabsTrigger value="pricing" className="data-[state=active]:bg-card data-[state=active]:shadow-sm">
            <DollarSign className="w-4 h-4 mr-2" />
            Pricing
          </TabsTrigger>
          <TabsTrigger value="trainers" className="data-[state=active]:bg-card data-[state=active]:shadow-sm">
            <Users className="w-4 h-4 mr-2" />
            Trainers
          </TabsTrigger>
          <TabsTrigger value="features" className="data-[state=active]:bg-card data-[state=active]:shadow-sm">
            <ToggleLeft className="w-4 h-4 mr-2" />
            Features
          </TabsTrigger>
          <TabsTrigger value="display" className="data-[state=active]:bg-card data-[state=active]:shadow-sm">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1 space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="logo-upload" type="file" accept="image/*" className="cursor-pointer" />
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <div className="w-10 h-10 rounded-lg gradient-primary border border-border" />
                    <Input id="primary-color" defaultValue="#1a365d" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="accent-color">Accent Color</Label>
                  <div className="flex gap-2">
                    <div className="w-10 h-10 rounded-lg gradient-accent border border-border" />
                    <Input id="accent-color" defaultValue="#0d9488" />
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { name: "Basic", price: "$9.99", features: ["Access to recorded sessions", "Basic nutrition tracking", "Community forums"] },
                  { name: "Premium", price: "$24.99", features: ["All Basic features", "Live sessions access", "1-on-1 coaching", "Advanced analytics"] },
                  { name: "Elite", price: "$49.99", features: ["All Premium features", "Priority support", "Custom meal plans", "Personal trainer"] },
                ].map((plan) => (
                  <div key={plan.name} className="p-4 rounded-xl border border-border hover:border-accent transition-colors">
                    <h4 className="font-semibold text-foreground">{plan.name}</h4>
                    <p className="text-2xl font-bold text-accent mt-1">{plan.price}<span className="text-sm text-muted-foreground font-normal">/mo</span></p>
              ...
              <div className="pt-4 border-t border-border">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-base font-medium">Coupon Codes</Label>
        ...
        <TabsContent value="trainers" className="space-y-6 animate-fade-in">
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="font-display">Trainer Approval Workflow</CardTitle>
              <CardDescription>Configure how trainers are onboarded to your platform</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                <div>
                  <Label className="text-base font-medium">Require Admin Approval</Label>
                  <p className="text-sm text-muted-foreground">New trainers must be approved before accessing the platform</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                <div>
                  <Label className="text-base font-medium">Background Check Required</Label>
                  <p className="text-sm text-muted-foreground">Require verification documents from trainers</p>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                <div>
                  <Label className="text-base font-medium">Auto-assign New Trainers</Label>
                  <p className="text-sm text-muted-foreground">Automatically assign new trainers to available slots</p>
                </div>
                <Switch />
              </div>
            </CardContent>
                    ...
                    {[
                      ...
                      >
                        <option.icon className={cn(
                          "w-5 h-5",
                          theme === option.value ? "text-accent" : "text-muted-foreground"
                        )} />
                        <span className={cn(
                          "text-sm",
                          theme === option.value ? "text-accent font-medium" : "text-muted-foreground"
                        )}>
                          {option.label}
                        </span>
                      </button>
