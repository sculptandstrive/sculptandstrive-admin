        ...
        <Card className="border border-border rounded-2xl shadow-sm border-l-4 border-l-destructive bg-card">
          <CardContent className="p-5 flex justify-between items-center">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-3xl font-semibold text-foreground tracking-tight leading-none mt-1.5">{tickets.filter(t => t.status === 'open').length}</p>
            </div>
        ...
        <Card className="border border-border rounded-2xl shadow-sm border-l-4 border-l-amber-500 bg-card">
          <CardContent className="p-5 flex justify-between items-center">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-3xl font-semibold text-foreground tracking-tight leading-none mt-1.5">{tickets.filter(t => t.status === 'in_progress').length}</p>
            </div>
        ...
        <Card className="border border-border rounded-2xl shadow-sm border-l-4 border-l-emerald-500 bg-card">
          <CardContent className="p-5 flex justify-between items-center">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-3xl font-semibold text-foreground tracking-tight leading-none mt-1.5">{tickets.filter(t => t.status === 'resolved').length}</p>
            </div>
